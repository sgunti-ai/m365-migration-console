...
const tenantProfiles = {
  ...
  "Northwind Global": { factor: 0.56, display: "northwind.com", workloadShift: [4, -1, -2, -1] },
  "Northwind EU": { factor: 0.28, display: "eu.northwind.com", workloadShift: [-3, 2, 1, 0] },
  "Northwind LATAM": { factor: 0.16, display: "latam.northwind.com", workloadShift: [-1, -1, 2, 0] },
} as const;
